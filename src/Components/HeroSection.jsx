      ...
      <Container >
        ...
        <Stack direction={{ xs: "column", lg: "row" }} spacing={5}>
          <Box>
            ...
            <Box sx={{ mt: 3 }}>
              <Link href='#' color="info.light" sx={{ textDecoration: "none", "&:hover": { textDecoration: "underline" } }}>Learn more about the new features <ArrowForwardIcon sx={{ mb: -1 }} /></Link>
            </Box>
            <Typography sx={{ fontWeight: "bold", my: 5, display: { xs: 'none', md: 'block' } }}>Scan the code or enter your number to get the app.</Typography>
